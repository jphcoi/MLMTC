...
name_export_pkl=requete + '_dico_'+str(sample)+'_'+str(Nb_rows)
...
try:
	...
	dictionnaire_gramme=fonctions_lib.dumpingout(name_export_pkl,requete)
...
# 	print "\n--- finished processing redundant nlemmes " 


filename = path_req + requete + '_' + str(freqmin) + '_' + 'liste_n-grammes_freq.txt'
######!!!!!!!#version pour calculer le bruit de fond sur la couronne
filename = path_req + requete + '_' + str(freqmin) + '_' + 'liste_n-grammes_freq_divers.csv'
filename_redond =  path_req + requete + '_' + str(freqmin) + '_' + 'liste_n-grammes_freq_divers_noredond.csv'
filename_redond_leven =  path_req + requete + '_' + str(freqmin) + '_' + 'liste_n-grammes_freq_divers_leven_noredond.csv'
